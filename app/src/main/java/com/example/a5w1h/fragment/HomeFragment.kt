...
class HomeFragment : Fragment(), SelectedWordListInterface {
    ...
    override fun onCreateView(
        ...
        autoAddBtn.setOnClickListener(View.OnClickListener {
            if (wordList.size > 0) {
                wordList.clear()
            }
            for (i in 0..4) {
        ...
        manualAddBtn.setOnClickListener(View.OnClickListener {
            BottomFragment(this).show(requireActivity().supportFragmentManager, "TAG")
        })
        startLearn.setOnClickListener(View.OnClickListener {
            if (wordList.size > 0) {
